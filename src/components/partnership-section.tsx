...
export default function PartnershipSection() {
  return (
    ...
    //       />
    //       <button className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 transform translate-x-[-20%] z-20 bg-white text-[#2C3E50] px-8 md:px-10 py-3 md:py-4 rounded-lg font-semibold text-sm md:text-base hover:bg-gray-50 transition-colors shadow-lg whitespace-nowrap">
    //         Get in Touch
    //       </button>
    //     </div>
    //   </div>
    ...
    //       <div className="flex-1 flex flex-col gap-3 md:gap-4 max-w-full md:max-w-[650px] text-center md:text-left">
    //         <h2 className="text-2xl md:text-2xl lg:text-3xl font-bold text-[#0C3055] font-unbounded">
    //           Partner With Us to Build Resilient Systems That Matter
    //         </h2>
    //         <p className="text-sm md:text-base lg:text-lg font-normal text-[#E9F4FF] leading-relaxed">
    //           Let's work together to turn data into durable impact for
    ...
    //         <button className="bg-white text-[#2C3E50] px-8 py-3 rounded-lg font-semibold text-sm hover:bg-gray-50 transition-colors shadow-lg whitespace-nowrap">
    //           Get in Touch
    //         </button>
    //       </div>
    //     </div>
